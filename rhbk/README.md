...
This guide covers the deployment of Red Hat build of Keycloak Operator configured with a `rhdh` realm and `rhdh-catalog` client configured.
...
5. Import the realm "rhdh-realm.json" into Red Hat build of Keycloak console
![Create Realm](./CreateRealm1.png)
![Create Realm2](./CreateRealm2.png)